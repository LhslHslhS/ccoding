...
Land land1[3] = {1, 3, {4, 4}, 100};
Land land2[3] = {2, 3, {20, 4}, 100};
Land land3[3] = {3, 3, {36, 4}, 100};
Land land4[3] = {4, 3, {52, 4}, 100};
Land land5[3] = {5, 1, {4, 20}, 100};
Land land6[3] = {6, 3, {52, 20}, 100};
Land land7[3] = {7, 3, {4, 36}, 100};
Land land8[3] = {8, 2, {52, 36}, 100};
Land land9[3] = {9, 3, {4, 52}, 100};
Land land10[3] = {10, 3, {20, 52}, 100};
Land land11[3] = {11, 3, {36, 52}, 100};
Land land12[3] = {12, 3, {52, 52}, 100};
...
int sucess;
int sucessPer;
char BoomPecent[10] ={ 0, 0, 5, 7, 10, 15, 20, 30, 50, 70};
int Boom;
int BoomPer;
...
void playerOnVillage () {
	...
	}else if (mainMarket == 5)
	{
		...
		printf("------------------------------\n");
		scanf("%d", landMarket)
		if (land[landMarket].owner == 1 || land[landMarket].owner == 2)
		{
			printf("이미 주인이 있습니다.\n");
			return;
		}
		...
		}else if (chestMarket == 2)
		{
			...
			if (action == 1)
			{
				...
				}else if (inputNumber1 == 2)
				{
					if (inputNumber2 == 1)
					{
						...
						players[turn][turnTeam].chestMissile[0] += inputCount;
					}else if (inputNumber2 == 2)
					{
						...
						players[turn][turnTeam].chestMissile[1] += inputCount;
					}else if (inputNumber2 == 3)
					{
						...
						players[turn][turnTeam].chestMissile[2] += inputCount;
					}else if (inputNumber2 == 4)
					{
						...
						players[turn][turnTeam].chestMissile[3] += inputCount;
					}else if (inputNumber2 == 5)
					{
				...
				}else if (inputNumber1 == 3)
				{
					if (inputNumber2 == 1)
					{
						...
						players[turn][turnTeam].chestRocket[0] += inputCount;
					}else if (inputNumber2 == 2)
					{
						...
						players[turn][turnTeam].chestRocket[1] += inputCount;
					}else if (inputNumber2 == 3)
					{
						...
						players[turn][turnTeam].chestRocket[2] += inputCount;
					}else if (inputNumber2 == 4)
					{
						...
						players[turn][turnTeam].chestRocket[3] += inputCount; 
					}
			...
			}else if (action == 2)
			{
				...
				if (inputNumber1 == 1)
				{
					if (inputNumber2 == 1)
					{
						if (inputCount > players[turn][turnTeam].chestmineral[0])
						{
							printf("에메랄드가 부족합니다.\n");
							playerOnVillage();
						}
					...
					{
						if (inputCount > players[turn][turnTeam].chestmineral[1])
						{
							printf("다이아몬드가 부족합니다.\n");
							playerOnVillage();
						}
					...
					{
						if (inputCount > players[turn][turnTeam].chestmineral[2])
						{
							printf("금이 부족합니다.\n");
							playerOnVillage();
						} 
					...
					{
						if (inputCount > players[turn][turnTeam].chestmineral[3])
						{
							printf("철이 부족합니다.\n");
							playerOnVillage();
						}  
					...
					{
						if (inputCount > players[turn][turnTeam].chestmineral[4])
						{
							printf("레드스톤이 부족합니다.\n");
							playerOnVillage();
						}  
					...
					{
						if (inputCount > players[turn][turnTeam].chestmineral[5])
						{
							printf("청금석이 부족합니다.\n");
							playerOnVillage();
						}  
					...
					{
						if (inputCount > players[turn][turnTeam].chestmineral[6])
						{
							printf("석탄이 부족합니다.\n");
							playerOnVillage();
						}  
					...
					{
						if (inputCount > players[turn][turnTeam].chestmineral[7])
						{
							printf("돌이 부족합니다.\n");
							playerOnVillage();
						} 
						players[turn][turnTeam].mineral[chest7] -= inputCount;
						chest[turn].mineral[7] += inputCount;
					}
				}else if (inputNumber1 == 2)
				{
					if (inputNumber2 == 1)
					{
						if (inputCount > players[turn][turnTeam].chestMissile[0])
						{
							printf("핵 미사일이 부족합니다.\n");
							playerOnVillage();
						} 
						players[turn][turnTeam].Missile[0] -= inputCount;
						chest[turn].chestchestMissile[0] += inputCount;
					}else if (inputNumber2 == 2)
					{
						if (inputCount > players[turn][turnTeam].chestMissile[1])
						{
							printf(" 빨강 미사일이 부족합니다.\n");
							playerOnVillage();
						} 
						players[turn][turnTeam].Missile[1] -= inputCount;
						chest[turn].chestchestMissile[1] += inputCount;
					}else if (inputNumber2 == 3)
					{
						if (inputCount > players[turn][turnTeam].chestMissile[2])
						{
							printf(" 요격 미사일이 부족합니다.\n");
							playerOnVillage();
						} chest[turn].chestMissile[2] -= inputCount;
						playerschestrs[tur[turnTeam]nnTeam].chestMissile[2] += inputCount;
					}elschestnputNu)
					{
						if (inputCount > players[turn][turnTeam].chestMissile[3])
						{
							printf(" 뇌관 제거기가 부족합니다.\n");
							playerOnVillage();
						} 
						players[turn][turnTeam].Missile[3] -= inputCount;
						chest[turn].chestchestMissile[3] += inputCount;
					}else if (inputNumber2 == 5)
					{
						if (inputCount > players[turn][turnTeam].chestMissile[4])
						{
							printf(" 레이더가 부족합니다.\n");
							playerOnVillage();
						} 
						players[turn][turnTeam].Missile[3] -=chest inputCount;
						chest[turn].chestMissile[3] += inputCount;
					}
				}else if (inputNumber1 == 3)
				{
					if (inputNumber2 == 1)
					{
						if (inputCount > players[turn][turnTeam].chestRocket[0])
						{
							printf("특수 로켓이 부족합니다.\n");
							playerOnVillage();
						} 
						players[turn][turnTeam].Rocket[0] -= inputCount;
						chest[turn].chestchestRocket[0] += inputCount;
					}else if (inputNumber2 == 2)
					{
						if (inputCount > players[turn][turnTeam].chestRocket[1])
						{
							printf("안전한 로켓이 부족합니다.\n");
							playerOnVillage();
						} 
						players[turn][turnTeam].Rocket[1] -= inputCount;
						chest[turn].chestchestRocket[1] += inputCount;
					}else if (inputNumber2 == 3)
					{
						if (inputCount > players[turn][turnTeam].chestRocket[2])
						{
							printf("희미한 로켓이 부족합니다.\n");
							playerOnVillage();
						} 
						players[turn][turnTeam].Rocket[2] -= inputCount;
						chest[turn].chestchestRocket[2] += inputCount;
					}else if (inputNumber2 == 4)
					{
						if (inputCount > players[turn][turnTeam].chestRocket[3])
						{
							printf("완벽한 로켓이 부족합니다.\n");
							playerOnVillage();
						}
						players[turn][turnTeam].Rocket[3] -= chestinputCount;
						chest[turn].chestRocket[3] += inputCount; 
					}
					}else if (inputNumber1 == 4)
					{
						if (inputCount > players[turn][turnTeam].chestGoldenApple)
						{
							printf("황금 사과가 부족합니다.\n");
							playerOnVillage();
						}
						playershest[t[tum]urn].chestGoldenApple -chest= inchestt;
						[turn][turnTeam].GoldenApple += inputCount;
					}
	...
	}else if (mainMarket == 9)
	{
		...
		}else if (reinforceMarket == 4)
		{
			...
			if (reinForceItem == 1)
			{
				...
				sucessPer = sucessPercent[players[turn][turnTeam].sword.reinforce[0] + 1] + firstStoneCount * 5;
				BoomPer = 100 - BoomPercent[players[turn][turnTeam].sword.reinforce[0] + 1] + secondStoneCount * 5;
			...
			if (boom < 100)
			{
				if (players[turn][turnTeam].armors[reinForceItem - 2] = helmetBase||players[turn][turnTeam].armors[reinForceItem - 2] = helmetIron||players[turn][turnTeam].armors[reinForceItem - 2] = helmetDiamond)
				{
					players[turn][turnTeam].armors[reinForceItem - 2] = helmetBase;
				}else if (players[turn][turnTeam].armors[reinForceItem - 2] = chestplateBase||players[turn][turnTeam].armors[reinForceItem - 2] = chestplateIron||players[turn][turnTeam].armors[reinForceItem - 2] = chestplateDiamond)
				{
					players[turn][turnTeam].armors[reinForceItem - 2] = chestplateBase;
				}else if (players[turn][turnTeam].armors[reinForceItem - 2] = leggingsBase||players[turn][turnTeam].armors[reinForceItem - 2] = leggingsIron||players[turn][turnTeam].armors[reinForceItem - 2] = leggingsDiamond)
				{
					players[turn][turnTeam].armors[reinForceItem - 2] = leggingsBase;
				}else if (players[turn][turnTeam].armors[reinForceItem - 2] = bootsBase||players[turn][turnTeam].armors[reinForceItem - 2] = bootsIron||players[turn][turnTeam].armors[reinForceItem - 2] = bootsDiamond)
				{
	...
	players[turn][turnTeam].reinforce[0] -= players[turn][turnTeam].
